        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav">
                    <li><a href="<?php echo e(url('/test')); ?>">測驗</a></li>
                    <li><a href="<?php echo e(url('/history')); ?>">紀錄</a></li>
                    <li><a href="<?php echo e(url('/textbook')); ?>">資源</a></li>
                </ul>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown ">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="<?php echo e(url('/logout')); ?>"><i class="fa fa-btn fa-sign-out"></i>登出</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
